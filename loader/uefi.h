...
typedef EFI_STATUS (EFIAPI *EFI_GRAPHICS_QUERY_MODE)(
    struct EFI_GRAPHICS_OUTPUT_PROTOCOL *, u32, UINTN *,
    EFI_GRAPHICS_OUTPUT_MODE_INFORMATION **);
typedef EFI_STATUS (EFIAPI *EFI_GRAPHICS_SET_MODE)(
    struct EFI_GRAPHICS_OUTPUT_PROTOCOL *, u32);
