...
#define JCOS_SYSCALL_CLOCK_TICKS           6
#define JCOS_SYSCALL_CLOCK_FREQUENCY       7
#define JCOS_SYSCALL_DISPLAY_INFO          8
#define JCOS_SYSCALL_DISPLAY_PRESENT       9
#define JCOS_SYSCALL_AUDIO_INFO            10
#define JCOS_SYSCALL_AUDIO_WRITE           11
